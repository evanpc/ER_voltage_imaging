...
%To note: stim times, pre, and post, need to be numbers of matlab columns

%To note: THIS FUNCTION NORMALIZES THE COMPILED TRACES TO SET PERIOD OF 1S
%BEGINNING AT 1.5S BEFORE EACH STIM (ASSUMING 10HZ RECORDING SPEED)
...
function compiled=nrm_cmple(trace,stim_times,pre,post)
